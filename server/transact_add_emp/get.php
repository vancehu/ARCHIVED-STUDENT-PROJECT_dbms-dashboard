...
{
	$select =  'order_id, order_time, quantity, transact_add.pid, pname';
	$from = 'transact_add, employee, product';
	$cond = ' WHERE transact_add.pid = product.pid AND transact_add.eid = employee.eid AND employee.eid="'.$_SESSION['user']['info']['eid'].'"';
