...
//query condition - MODIFY HERE ONLY
{
	...
	$cond = ' WHERE transact_sell.cid = customer.cid AND transact_sell.pid = product.pid AND transact_sell.eid = employee.eid AND employee.eid="'.$_SESSION['user']['info']['eid'].'"';
